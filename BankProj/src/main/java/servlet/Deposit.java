...
public class Deposit extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Integer money = Integer.parseInt(request.getParameter("money")); // form에 입력된 입금액
		...
		if(acc!=null) {
			...
			request.setAttribute("page", "accountinfo"); // page파라미터값을 문자열로 넘겨서 인클루드 되도록 함(인클루드처리는 jsp가 한다)
		} else {
